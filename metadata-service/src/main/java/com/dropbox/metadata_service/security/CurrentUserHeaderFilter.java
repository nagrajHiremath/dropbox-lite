package com.dropbox.metadata_service.security;
 ...
 * validated the caller's JWT (see GWT-01). Metadata Service sits behind the gateway
 * and does not re-validate JWTs itself.
 */
